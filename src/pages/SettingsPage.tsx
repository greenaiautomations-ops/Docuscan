  ...
  return (
    <div className="mx-auto flex max-w-lg flex-col gap-6">
      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-5">
        <h2 className="mb-3 text-sm font-semibold text-slate-700 dark:text-slate-300">Account</h2>
      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-5">
        <h2 className="mb-3 text-sm font-semibold text-slate-700 dark:text-slate-300">Appearance</h2>
        <p className="mb-3 text-sm text-slate-500 dark:text-slate-400">Choose how Docuscan looks on this device.</p>
      ...
      <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-5">
        <h2 className="mb-3 text-sm font-semibold text-slate-700 dark:text-slate-300">Reminders</h2>
        <ReminderSettings />
      </div>
    </div>
  )
